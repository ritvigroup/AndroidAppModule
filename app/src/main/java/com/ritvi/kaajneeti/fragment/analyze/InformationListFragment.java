...
import com.ritvi.kaajneeti.adapter.InformationAnalyzeAdapter;
...
public class InformationListFragment extends Fragment {
    ...
    public void callAPI() {
        ...
        }, InformationPOJO.class, "call_complaint_list_api", true).execute(WebServicesUrls.INFORMATION_LIST);
    }


    List<InformationPOJO> complaintPOJOS = new ArrayList<>();
    InformationAnalyzeAdapter complaintAnalyzeAdapter;

    public void attachAdapter() {

        complaintAnalyzeAdapter = new InformationAnalyzeAdapter(getActivity(), this, complaintPOJOS);
