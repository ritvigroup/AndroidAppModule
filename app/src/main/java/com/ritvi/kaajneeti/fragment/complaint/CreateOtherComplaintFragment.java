...
public class CreateOtherComplaintFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    TextView et_applicant_name;
    @BindView(R.id.et_applicant_father_name)
    TextView et_applicant_father_name;
    @BindView(R.id.et_applicant_mobile)
    TextView et_applicant_mobile;


    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_other_complaint_add, container, false);
    ...
    public CreateOtherComplaintFragment(List<String> mediaFiles, String privPublic, String complaint_name) {
        ...
        iv_calendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(
                        CreateOtherComplaintFragment.this,
    ...
    public void saveComplaint() {
        try {
            if (leaderProfilePOJO != null) {
                ...
                UserProfilePOJO userProfilePOJO = Constants.userProfilePOJO;
                reqEntity.addPart("applicant_name", new StringBody(et_applicant_name.getText().toString()));
                reqEntity.addPart("applicant_father_name", new StringBody(et_applicant_father_name.getText().toString()));
                reqEntity.addPart("applicant_mobile", new StringBody(et_applicant_mobile.getText().toString()));
