...
public class AddGroupComplaintDescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            taggedUserProfilePOJOS = (List<UserProfilePOJO>) bundle.getSerializable("taggedpeople");
        }
    ...
    public void saveComplaint() {
        try {
            ...
            for(int i=0;i<taggedUserProfilePOJOS.size();i++){
                reqEntity.addPart("complaint_member["+i+"]",new StringBody(taggedUserProfilePOJOS.get(i).getCitizenProfilePOJO().getUserProfileId()));
            }
                ...
                public void onGetMsg(String apicall, String response) {
                    ...
                    try {
                        ...
                        if (jsonObject.optString("status").equals("success")) {
                            startActivity(new Intent(AddGroupComplaintDescriptionActivity.this, ApplicationSubmittedActivity.class).putExtra("comp_type", "complaint"));
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
