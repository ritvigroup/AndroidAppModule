...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public NotificationAdapter(Activity activity, Fragment fragment, List<String> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tv_description.setText("Sunil Vishwakarma created Complaint and requested you to sign the complaint Application");
