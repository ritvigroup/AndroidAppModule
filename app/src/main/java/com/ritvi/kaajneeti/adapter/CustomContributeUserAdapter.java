...
public class CustomContributeUserAdapter extends ArrayAdapter<UserProfilePOJO> {
    ArrayList<UserProfilePOJO> customers, tempCustomer, suggestions;
    Context context;

    public CustomContributeUserAdapter(Context context, ArrayList<UserProfilePOJO> objects) {
